...
lightbox.option({
  ...
  'wrapAround': true, // Allows user to loop through images
  'maxWidth': 1200, // Important for wide data dashboards
  'disableScrolling': true, // Prevents background scroll while viewing
  'positionFromTop': 50
});*/